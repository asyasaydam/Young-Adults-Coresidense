...
log 		using "$logdir/NLSY97extract_health_`logdate'.log", t replace



import delimited "$NLSY1997\default_health_assets.csv"
rename *, upper
...
save "$created_data/NLSY97_extract_health_asset", replace
