...
* IPUMS 2004-2019 ACS - additional occ variable
...
log 		using "$logdir/ipumsextract3_`logdate'.log", t replace
...
save "$created_data/ipums3_extract", replace
