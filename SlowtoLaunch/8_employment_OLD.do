...
forvalues y=1980/2019{
	...
	replace 	fullpartyearemployment`y' = 0 if weekswork`y' == 0
	replace 	fullpartyearemployment`y' = 1 if weekswork`y' < 44.2 & weekswork`y' != 0 & weekswork`y' != .
	replace 	fullpartyearemployment`y' = 2 if weekswork`y' > 44.2 & weekswork`y' != .
	label 		define fullpartyearemployment`y' 0 "No employment" 1 "Part-year employment" 2 "Full-year employment"
...
forvalues y=1980/2019{
	recode 		yearempstatus`y' (0=0)(0.1/35=1)(35.01/333=2), gen(yearempstat`y')
...
forvalues y=1980/2019{
	...
	label 		define employmentstatus`y' 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
	label 		val employmentstatus`y' employmentstatus`y'
}
...
label 		define empstatge15 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge16 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge17 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge18 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge19 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge20 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge21 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge22 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge23 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge24 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge25 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge26 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge27 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge28 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge29 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge30 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge31 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge32 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge33 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
...
label 		define empstatge34 0 "No employment during the year" 1 "Part-time employment" 2 "Full time employment that is part year" 3 "Year round full time employment"
label 		val empstatge34 empstatge34	
	
	
	**** since age 24 is key, I will proximate age 24 employment status from age 23 and age 25
	replace empstatge24 = empstatge25 if empstatge24 == . & empstatge23 == empstatge25 // 26 changes, this is both male & female
	** Crude proximate I will fill in with age 25 observations if age 24 and age 23 is missing, I'll do the same woth age 23
	replace empstatge24 = empstatge25 if empstatge24 == . & empstatge23 == . // 99
	replace empstatge24 = empstatge23 if empstatge24 == . & empstatge25 == . // 177
...
forvalues y=15/34 {
	...
	label define empstatusage`y' 0 "No employment during the year" 1 "Part-time or part year employment" 2 "Fulltime full year employment"
