...
******* REDO below *******
	set maxiter 20
	mi set wide
	mi register imputed hh_income97 parenteduc aveagree aveemost aveopen avecons aveextra genhlt24 asvabscore havedebt30 enrolled24 children24 children32 empstatusage24 unionstatus32 unionstatus24 livingat24 livingat25 livingat26 livingat27 livingat28 livingat29 
...
* I muted this, this is related to "duration" make sure to add that.
	...
	label 	val livedwpar_cat4_comp livedwpar_cat4_comp
		...
		save "$temp/mi_datacreated100impOcc_alt2", replace
