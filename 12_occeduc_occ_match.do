...
keep 		ID SEX BYEAR yearatage32 occupation_*_2011 occupation_*_2013 occupation_*_2015 occupation_*_2017 occupation32_1 occupation32_2 occupation32_3 occupation32_4
...
merge		m:m occnum using "$temp/ipumsoccpoolfinaltomerge2440" 
drop if		 _merge == 2
drop 		_merge
...
rename occupationaleduc occeduc_1
rename occnum occnum1
rename occ2010 occ2010_1

save "$temp/firstjobmatchedoccedu", replace
...
rename occupationaleduc occeduc_2
rename occnum occnum2
rename occ2010 occ2010_2
save "$temp/secondjobmatchedoccedu", replace
...
rename occupationaleduc occeduc_3
rename occnum occnum3
rename occ2010 occ2010_3
save "$temp/thirdjobmatchedoccedu", replace
...
rename occupationaleduc occeduc_4
rename occnum occnum4
rename occ2010 occ2010_4
save "$temp/fourthjobmatchedoccedu", replace
