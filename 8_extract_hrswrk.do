...
* Extract and Rename number of weekly hours work variables
...
log 		using "$logdir/NLSY97extract_hrswrk_`logdate'.log", t replace


import delimited "$NLSY1997\hita_hourswork.csv"
rename *, upper
...
save "$created_data/NLSY97_extract_hrswrk", replace
