...
log 		using "$logdir/NLSY97psmendescp_`logdate'.log", t replace
...
*template
putexcel set "$results/HitaNLSY_DescriptivePropensity.xlsx", sheet("hitaPmen_update") modify
...
***** Outcome 2: Occupational Education
...
tab 	education_new livedwpar_cat [aweight=SAMPLING_PANEL_WEIGHT_1997], matcell(edu)
